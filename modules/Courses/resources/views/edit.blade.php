            ...
            <div class="col-6">
                <div class="mb-3">
                    ...
                    <input type="number" name="sale_price"
                        ...
                        placeholder="Mã giá khuyến mãi..." value="{{ old('sale_price') ?? $course->sale_price }}">
                    @error('sale_price')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
            ...
            <div class="col-6">
                <div class="mb-3">
                    ...
                    <select name="is_document" id=""
                        ...
                        <option value="0"
                            {{ old('is_document') == 0 || $course->is_document == 0 ? 'selected' : false }}>Không
                        </option>
                        <option value="1"
                ...
                <div class="mb-3">
                    ...
                    <select name="status" id=""
                        ...
                        <option value="0" {{ old('status') == 0 || $course->status == 0 ? 'selected' : false }}>Chưa
                            ra mắt</option>
                        <option value="1" {{ old('status') == 0 || $course->status == 1 ? 'selected' : false }}>Đã ra
                            mắt</option>
                    </select>
                    @error('status')
                        <div class="invalid-feedback">
            ...
            <div class="col-12">
                <div class="mb-3">
                    ...
                    <textarea type="text" name="supports" class="form-control {{ $errors->has('supports') ? ' is-invalid' : '' }}"
                        placeholder="Hỗ trợ..." value="">{{ old('supports') ?? $course->supports }}</textarea>
                    @error('supports')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
            ...
            <div class="col-12">
                <div class="mb-3">
                    ...
                    <textarea type="text" name="detail" class="form-control ckeditor {{ $errors->has('detail') ? ' is-invalid' : '' }}"
                        placeholder="Hỗ trợ..." value="">{{ old('detail') ?? $course->detail }}</textarea>
                    @error('detail')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
            ...
            <div class="col-12">
                <div class="mb-3">
                    ...
                    <div class="list_categories">
                        {{ getCategoriesCheckbox($categories, old('categories') ?? $categoryId) }}
                    </div>
                    @error('categories')
